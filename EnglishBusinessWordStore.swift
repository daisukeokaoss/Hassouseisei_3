...
class EnglishBusinessWordStore: WordStore {
    ...
    override func ReturningWordArray() -> Array<String>{
        ...
        "catastrophic policy","catastrophic risk","Catch carriers","Catchfly","Catechu","Cated abrasive products","categorical assistance","categorically needy","category",
        "category of insurance","Caterpillar circular saw banches","Caterpillar horizontal band resaws","Caterpillar table band resaws","Catgut","Catgut for musical instruments",
        "Catheters","Cathetometers","Cathode for aluminium production","Cathode ray tubes","Cathodes","Cathodic anti-corrosion apparatus","Cation exchange resin","Cationic dyes",
        "Cationic surface-active agents","Cationic synthetic detergents","Catoridge cameras","Cats","CATS","cats and dogs","Cattle","Cattle and horse body hair","Cattle beet seeds",
        "Cattle cake","Cattle carriers","Cattle chains","Cattle exercising machines","Cattle food","Cattle for breeding","Cattle hairs","Cattle hides","Cattle leaders","Cattle leather",
        "Cattle marking tools","Cattle shearers","Cattle skinning instruments","Cattle skins","Cattle Stunning apparatus","Cattle stunning appliances","Cattle tail hair","Cattle washes",
        "Cattleyas","CATV","Cauldrons","Cauliflower seeds","Cauliflowers","Caulking irons","Caulking materials","cause of death","cause specific mortality rate","Caustic alkali",
        "Caustic pencils","Caustic soda for industrial purposes","Caustics for industrial purposes","Caustics for pharmaceutical purposes","caveat emptor","caveat venditor","Caviar",
        "Cavity resonators and oscillators","CAWL","Cazania seeds","CB","CBA","CBD","CBI","CBO","CBOT","CBP","CBRC","CBRN","CBSI","CCC","ＣＣＤ","CCF","CCH","CCIA","CCIC","CCO","CCOP",
        "CCRC","CCU","CCW","ＣＤ","CD annuity","CD-I","CD-QUERYS","CD-ROM","CD-ROMS","ＣＤ－Ｉ","ＣＤ－Ｒ０Ｍ","ＣＤ－ＲＯＭ","CDC","CDIC","CDM","CDR","CDS","CDT","CDU","CE","CEA","CEBS",
        "Cedar leaf oil","Cedar oils","Cedar wood for use as an insect repellent","Cedar wood oil","ceded premium","cedent","ceding commission","ceding company","Cedrol","Cedryl acetate",
        "Ceiling fans","Ceiling hooks","Ceiling lights","Ceiling panels","Ceiling type","Ceilings of metal","Ceilings, not of metal","CEIOPS","Celeriacs","Celeries","Celery oil","Celery salt",
        "Celery seeds","Celestial globes","cell","Cell analyzers","Cell switches","Cellophane sacks","Cellophane tapes","Cellophanes","Cellos","Cellular mobile telephone equipment",
        "Cellular telephone communication","Celluloid","Celluloid containers","Celluloids","Cellulose","Cellulose acetate plastics","Cellulose acetate, semi-processed","Cellulose acetate-butylate",
        "Cellulose acetate-butylate plastics","Cellulose acetate-propionate","Cellulose acetate-propionate plastics","Cellulose acetates","Cellulose acetates, for fiber",
        "Cellulose acetates, for lacquer","Cellulose acetates, for photographic film","Cellulose adhesives","Cellulose derivatives","Cellulose ester plastics","Cellulose esters for industrial purposes",
        "Cellulose esters for pharmaceutical purposes","Cellulose ether plastics","Cellulose ethers for industrial purposes","Cellulose ethers for pharmaceutical purposes",
        "Cellulose nitrate plastics","Cellulose nitrate, for celluloid","Cellulose nitrate, for lacquer","Cellulose nitrate, for photographic film","Cellulose nitrates",
        "Cellulose plastics","Cellulose wadding","Cellulose, derivatives and preparations","Celocias","Celosia seeds","Celtium","Cement","Cement and cement related products",
        "Cement blending agents","Cement carriers","Cement combustion furnaces","Cement copper","Cement disintegrating agents","Cement filling compound for surface preparation",
        "Cement for animal hooves","Cement for Blast furnaces","Cement for Boots","Cement for boots and shoes","Cement for Furnaces","Cement for mending broken articles",
        "Cement for pneumatic tires","Cement for Shoes","Cement mortar products","Cement posts","Cement preservatives, except paints and oils","Cement roofing tiles","Cement slabs",
        "Cement- Waterproofing chemicals, except paints","Cement-waterproofing preparations, except paints","Cemented carbide bits","Cemented carbide boring tools","Cemented carbide circular saw blades",
        "Cemented carbide cutting tools","Cemented carbide dies and plugs for enlargement","Cemented carbide drills","Cemented carbide end milling cutters",
        "Cemented carbide face milling cutters","Cemented carbide machinery parts","Cemented carbide metal slitting saws","Cemented carbide mining and civil engineering tools",
        "Cemented carbide reamers","Cemented carbide side milling cutters","Cemented carbide spikes","Cemented carbide tips","Cemented carbide tips for mining and civil engineering tools",
        "Cemented carbide tips for tools for wearing and corrosive application","Cemented carbide tips for tools for wearing and corrosive application,n.e.c.","Cemented carbide tool grinders for wood working",
        "Cemented carbide tools","Cemented carbide tools for wearing and corrosive application","census","Census Bureau","Centaurea seeds","Centaureas","centenarian","Center for Corporate Public Involvement",
        "Center For Insurance Research","Center for Medico-Actuarial Statistics","Center hole grinding machines","Center post type thickeners","Center reamers","Center shaft type thickeners",
        "Centering apparatus for photographic transparencies","Centering machines","Centerless grinding machines","Centerless internal cylindrical grinding machines",
        "Centers for Disease Control and Prevention","Centers for machine tools","Centers for Medicare and Medicaid Services","Central American Integration System","central bank",
        "central bank and monetary policy","central bank of Japan","Central heating radiators","Central Institute of Finance and Banking","Central Labor Relations Commission",
        "Central Licensing Bureau","Central monitors","Central nervous system stimulants","Central processing units","Central Provident Fund","Central Statistical Office",
        "Central tubes","Central vacuum cleaning installations","centralised scheme","centralization of capital","centralized agent database","Centralized lubrication system",
        "Centralized monitoring system","Centralized traffic control devices","Centrauthus","Centre for Policy on Ageing","Centre for the Financial Services Ombuds Network",
        "Centre punches","Centrifugal casting instruments","Centrifugal filters","Centrifugal machines","Centrifugal mills","Centrifugal precipitators","Centrifugal pumps","Centrifugal reels",
        "Centrifugal speed-meters","Centrifugal sugar","Centrifugal tachometers","Centrifugal turning amusement equipment","Centrifugal type","Centrifugal type blowers",
        "Centrifugal type fans","Centrifugal type turbo compressors","Centrifuge type clinical chemistry automated analyzers","Centrifuges","Centrifuges for haematocrit",
        "CEO","CEP","CEPEA","Cephem derivatives and antibiotic preparations","CER","Ceramic artificial bones and bone prostheses","Ceramic compositions for sintering","Ceramic containers",
        "Ceramic cooking utensils","Ceramic fibres","Ceramic filament fibre","Ceramic filters","Ceramic flower pots","Ceramic flower ware","Ceramic food storage utensils",
        "Ceramic glazings","Ceramic materials in particulate form, for use as filtering media","Ceramic ornaments","Ceramic packages","Ceramic paints","Ceramic preparation utensils",
        "Ceramic printed wiring boards","Ceramic single point tools","Ceramic spoons and saucers of spoons","Ceramic staple fibres","Ceramic substrates","Ceramic table utensils",
        "Ceramic tableware","Ceramic tips","Ceramic tools","Ceramic toys","Ceramic wares","Ceramic waste","Ceramic-glazed roofing tiles","Ceramics for household purposes",
        "Cereal flour, except rice flour and wheat flour","Cereal preparations","Cereal processed goods","Cereal processing machinery and equipment","Cereal seeds, unprocessed",
        "Cereal-based snack food","cerebral death","cerebral palsy","cerebrovascular disease","Ceresin wax","Ceresine","CERF","Ceric chloride","Ceric fluoride","Ceric hydroxide",
        "Ceric nitrate","Ceric oxide","Ceric sulphate","Cerium","Cerium chlorides","Cerium compounds","Cerium fluorides","Cerium hydroxides","Cerium nitrates","Cerium oxide","Cerium oxides",
        "Cermets","Cerous chloride","Cerous fluoride","Cerous hydroxide","Cerous nitrate","Cerous oxides","Cerous sulphates","certain installment option","certain option",
        "certificate","certificate of authority","certificate of authorization","certificate of compliance","certificate of deposit","Certificate of deposit cards","certificate of eligibility",
        "certificate of incorporation","certificate of insurance","Certificate of Insurance Practice","Certificate of Need","Certificate of Proficiency","certificate of registered seal",
        "certificate of reinsurance","Certificaye stamps","Certified Employee Benefit Specialist","Certified Financial Planner","Certified Financial Planner Board of Standards",
        "certified mail","Certified Pension Consultant","Certified Public Accountant","certified registered nurse","cervical cancer","CES","Cesium chloride","Cesium compounds",
        "Cesium hydroxide","Cesium ioidide","Cesium nitrate","Cesium oxide","Cesium sulphate","CESR","cession","cestui que vie","CET","CETS","Cetyl alcohol","Cetyl sulphate","CF",
        "CFA","CFC","CFE","CFIA&BA","CFO","CFOI","CFP","CFPB","CFS","CFSP","CFT","CFTC","CFV","CG","CGT","Chaff cutter blades","Chaff cutters","Chain adjusters","Chain barkers",
        "Chain blocks","Chain conveyors","Chain feeders","Chain guards","Chain link wire nettings","Chain mesh purses","Chain mortisers","Chain motors","chain of command","Chain pipe wrenches",
        "Chain saws","Chain speed reducers","Chain type stepless speed variators","Chaine blocks","Chains","Chains and leather cords","Chains for bicycles, cycles",
        "Chains for dogs","Chains of metal","Chainwheels and cranks","Chair cloth","Chair covers","Chair maker","Chairlifts","Chairs","Chairs for public establishment",
        "Chairs for vehicles, ships and aircraft","Chairs, seats, benches and stools","Chalk for billiard cues","Chalk for lithography","Chalk holders","Chalks","challenge",
        "Chamaedorea","Chamber of Commerce of the United States","Chamber pots","Chamber pots","Chambray","Chamois leather for cleaning","Chamois leather, other than for cleaning purposes",
        "Chamomile","Champagne glasses","chance of living","chancellor","Chancellor of the Exchequer","Chandelier type","Chandeliers","change in age","change in the staff",
        "change of beneficiary","change of function","change of insured","change of job","change of policy","change of policy contract","Change of trousers","Changers",
        "changing room","Channel black","channel of distribution","Channel planes","channels of distribution","Chaperoning","Chaplets","CHAPS","chapter","Chapter 10","Chapter 11",
        "Chapter 13","Chapter 7","Character indicator devices","Character recognition units","Charcoal","Charcoal briquetters","Charcoal canisters","Charcoal dust","Charcoal for artists",
        "Charcoal for pharmaceutical purposes","Charcoal from wood briquettes","Charcoal pencils","Charcuterie","Chards","charge","charge cap","Charge coupled devices",
        "charge off","Charge transfer devices","Chargers for electric batteries","Charging cranes","Charitable fund raising","charitable giving","charitable trust","charity care",
        "charity care at hospital","Charms","Charpy impact testing machines","chart","Chart pointers, non-electronic","charter","Chartered Accountant","Chartered Building Societies Institute",
        "Chartered Financial Analyst","Chartered Financial Consultant","Chartered Institute of Arbitrators","Chartered Insurance Broker","Chartered Insurance Institute",
        "Chartered Insurance Practitioner","Chartered Leadership Fellow","Chartered Life Underwriter","charterer","chartist","Charts","Charts , aeronautical charts","Chase Manhattan Corporation",
        "Chasing attachments","Chassis","Chassis frames","Chasubles","chattel","Chauffeur services","Chaul moogra and preparations","Chawanmushi","Chayote","CHC","CHD","cheap government",
        "cheap money","Check valves","Check verification","Check Verification","Check writers","check-o-matic","checkable account","Checked cloth","Checkerboards","Checkers",
        "checking account","checkup","Cheek brushes","Cheek color","Cheerries, prepared frozen foods","Cheese","Cheese and curd","Cheese cloth","Cheese melting kilns","Cheese pressers",
        "Cheese slicers, non-electric","Cheese vats","Cheese-dish covers","Chemical additives for oils","Chemical additives to Drilling muds","Chemical additives to Fungicides",
        "Chemical additives to Insecticides","Chemical additives to Motor fuel","Chemical analysis","Chemical carriers","Chemical compositions for repairing Leaks","Chemical Condensation preparations",
        "Chemical conductors for electrocardiograph electrodes","Chemical Contraceptives","Chemical cotton","Chemical fibres, carded or combed","Chemical foam fire extinguishing agents",
        "Chemical hoses","Chemical intensifiers for paper","Chemical intensifiers for rubber","Chemical lace fabrics","Chemical liquid equipment","Chemical liquid plaining equipment",
        "Chemical liquid supplying equipment","CHEMICAL MACHINERY","Chemical machinery, n.e.c.","Chemical oxygen demand meters",
        "Chemical preparations for Analyses in laboratories, other than for medical or veterinary purposes","Chemical preparations for Decarbonising engines",
        "Chemical preparations for facilitating the alloying of metals",]
        
        //http://ejje.weblio.jp/category/business/c
        //http://ejje.weblio.jp/category/business/c/12
        //http://ejje.weblio.jp/category/business/c/18
