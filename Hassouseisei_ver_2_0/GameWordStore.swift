...
class GameWordStore: WordStore{
    ...
    override func ReturningWordArray() -> Array<String>{
       ...
       "わたしのパンは…わたしのパンはっ…古河パンのお荷物だったんですねーっ…！","渡辺徹","ワックスを薄く伸ばす力","ワッフル","和風天文ステキ部活ドタバタ合宿ハッピー青春ラブラブラブラブラブコメディ",
        ...
        //http://www.blk.mmtr.or.jp/~sioumi/gayougo.htm
        wordArray = ["アーケーダー","アーケードゲーム","アキバ","アクション","アタリショック","アップライト筐体","アドバタイズ","アドベンチャー","アナログスティック","移植物","インカム","インスト",
            "インベーダーハウス","撃ち返し","裏技","永パ","エミュ","エンカウント","エンドレス","大須","お蔵入り","音ゲー","オペレータ","音源","格ゲー","カンスト","キーレスポンス","キックハーネス",
            "キャラゲー","筐体","筐体売り","行列","キラーソフト","クウォータービュー","口パク","クレジット","激レア","コアユーザー","コスり","コナミコマンド","コマンド技","コンシューマーゲーム",
            "コンパネ","コンプ","サービススイッチ","サイドビュー","サターン","三大聖地","システム基板","シミュレーション","シューター","シューティング","仕様です","常連","初回特典","処理落ち",
            "シンクロ連","スパる","スプライト","スプライトオーバー","スペック","スポーツ","全一","即死コンボ","ソフト","ソフトＤＩＰ","対戦台","タイムリリース","抱合せ販売","タコミス","ダビング機",
            "チート","中古撲滅キャンペーン","テーブル","テーブル筐体","ディストリビューター","デコ","デジコミ","デバッグ","電パ","道中","トップビュー","ドリームキャスト","なげる","名古屋撃ち",
            "日本橋","ネオジオ","納期","飲まれる","ハード","ハーネス","ハイスコアラー","パズル","パックマン訴訟","ハメ","ハメる","販促物","バンク切換え","頒布権","ピアノ打ち","ビデオゲーム",
            "ピヨる","ファミコン","プライズ","フライヤー","フラグ","フレーム","プリクラ","プレミア","別バージョン","ヘビーユーザー","ポリゴン","マジコン","マスターアップ","マルチエンディング",
            "マルチプラットフォーム","まわしプレイ","メガドライバー","メガドライブ","メスト","メンテ","モーションキャプチャー","モニター","焼く","読み込み","ライトユーザー","ラスタースクロール",
            "ランク","レゲー","連コイン","ロールプレイング","ロケーション","ロケテ","ＣＰＵ","ＤＩＰスイッチ","ＦＭ音源","ＪＡＭＭＡ","ＰＣＢ","ＰＣＭ音源","ＰＣエンジン","ＰＳＯ","ＲＡＭ",
            "ＲＯＭ","ＵＦＯキャッチャー","Ｚバッファ"]
        ReturnWordArray += wordArray
        
        //http://www.eonet.ne.jp/~zennin/dic_grf.htm
        
        wordArray = ["アーケード","アーケードゲーム","アイテム","「青いプレイステーション」","「青ステ」","アクション","アクションRPG","アクションゲーム","足譜","アスキー","アタリ","アタリショック",
            "アタリ神話","当たり判定","アダルトゲーム","@ barai","アドベンチャー","アドベンチャーゲーム","アナログコントローラー","アミューズメント施設","歩む会","アルゴリズム","安全地帯",
            "飯野賢治","育成ゲーム","育成シミュレーションゲーム","イサオ","移植","違法中古ソフト撲滅キャンペーン","違法中古ソフト撲滅キャンペーン","インカム","インスト","インストラクションカード",
            "裏技","永久パターン","永パ","えふえふ","エミュレータ","エモーションエンジン","エロゲー","エンカウント","エンディング","大川功","大阪訴訟","オートマッピング","落ちゲー","落ちものパズル",
            "お使いゲーム","音ゲー","大人買い","オプション","オペレーター","親父ゲー","オリハルコン","音声認識ソフト","温泉","オンラインゲーム","オンラインゲーム","カーソル","カートリッジ",
            "会心の一撃","格ゲー","カセット","仮想現実","家庭用ゲーム","家庭用ゲーム機","家庭用ゲーム機","カプコン","ガンシューティング","黄色いネズミ","基板","キャラクター","キャラゲー",
            "ギャルゲー","強制スクロール","筐体","業務用ゲーム","キラーソフト","切り返し","クイズ","空中ジャンプ","クソゲー","グッドエンディング","クリア","クリティカルヒット","クレジット",
            "グローシェーディング","黒いCD-ROM","「黒ステ」","クロスレビュー","「黒プレイステーション」","経験値","携帯ゲーム機","痙攣撃ち","ゲーセン","ゲーマー","ゲーム","「ゲーム＆ウォッチ」",
            "ゲームオーバー","「ゲームギア」","「ゲームキューブ」","ゲームクリエイター","ゲーム コンストラクション ソフト","ゲーム雑誌","ゲームショップ","ゲームセンター","ゲームバランス",
            "ゲームブック","「ゲームボーイ」","「ゲームボーイ アドバンス」","「ゲームボーイカラー」","ゲーメスト","決算期","現行機","コーエー","効果音","広技苑","後継機","攻略本","こすり",
            "コナミ","コナミコマンド","コナミ肖像権独占問題","コナミ商標問題","コナミ訴訟問題","コナミ不買運動","コマンド","コンシューマ","コンシューマゲーム","コンシューマゲーム機","コンストラクション ソフト",
            "コンソール","コンソールゲーム","コンソールゲーム機","コンソールソフト","コンティニュー","コントローラー","コンビニ流通","コンピュータ・エンターテインメント・ソフトウェア協会",
            "コンピュータ・グラフィックス","コンピュータ・ソフトウェア著作権協会","コンピュータ・ソフトウェア倫理機構"]
        ReturnWordArray += wordArray
        //http://www.eonet.ne.jp/~zennin/dic_grf.htm
        wordArray = ["サードパーティ","サイバーシックネス","サウンドエフェクト","サウンドノベル","雑魚","サターン","「サテラビュー」","サバイバルホラー","残機","残機制","残機潰し","サンディスティック",
             "次世代機","次世代機戦争","視点切り替え","シナリオ","シミュレーション","シミュレーションゲーム","写真シール作成機","ジャンル","シューター","シューティング","シューティングゲーム",
             "週刊ファミ通","週刊ファミ通のクロスレビュー","十字キー","周辺機器","ジョイスティック","仕様","仕様書","商標","初心会","振動パック","「スーパーファミコン」","「スーパーファミコン CD（仮称）」",
            "「スーパーファミコンジュニア」","スーファミ","スクウェア","スクウェア","スクエア","スケルトン","スコア","スタッフロール","スタンドアローン","ステージ","ステータス","スプライト",
            "『スペランカー』","スポーツ","スライム","セーブ","セーブデータ","制限時間","セガ","セガ・エンタープライゼス","「セガサターン」","セガ・バンダイ","セカンドパーティ","セサ",
            "全日本アミューズメント施設営業者協会連合会","専用コントローラ","ソニー","ソニー・コンピュータ・エンターテインメント","ソニータイマー","ソフト","ソフトハウス","ソフトメーカー",
            "ソフトリセット","ソフ倫"]
        ReturnWordArray += wordArray
        
        //http://www.eonet.ne.jp/~zennin/dic_grf.htm
        wordArray = ["ターン","体感ゲーム","大技林","大作","対戦格闘アクションゲーム","高橋名人","縦シュー","縦スクロールシューティング","たまごっち","ダンジョン","『ダンスダンスレボリューション』",
            "弾幕","ダンレボ","中央処理装置","中古ゲームと歩むユーザーの会","中古ゲームソフト","中古ゲームソフト販売訴訟","中古ゲームソフト問題","ツール","通信対戦","『ツクール』シリーズ",
            "強者","データイースト","データ放送","テーブルゲーム","テーブルトークRPG","ディーディーアール","ディスク","ディスクカード","「ディスクシステム」","ディスクライター","停電","『テイルズ』シリーズ",
            "テクスチャー","テクスチャーマッピング","デコ","デコゲー","デジキューブ","『デスクリムゾン』","『テトリス』","『テトリス』の悲劇 ","デバステ","デバッガ","デバッギングステーション","デバッグ",
            "デベロッパー","デュアルショック","デュアルショック ２","テレビゲーム","ＴＶゲーム専門店協会","テレビゲームソフトウェア流通協会","ＴＶゲームビジネス協議会","殿堂入り","東京ゲームショウ",
            "東京訴訟","登録商標","ときメモ","ドキャス","ドット","ドット職人","トライエース","ドライブゲーム","ドラクエ","ドラゴンクエスト　シリーズ","『ドラゴンクエスト』","『ドラゴンクエスト II　～悪霊の神々～』",
            "『ドラゴンクエスト III　そして伝説へ…』","『ドラゴンクエスト IV　導かれし者たち』","『ドラゴンクエスト V　天空の花嫁』","『ドラゴンクエスト VI　幻の大地』","『ドラゴンクエスト VII　エデンの戦士たち』",
            "『ドラゴンクエスト I・II』","『スーパーファミコン ドラゴンクエスト III そして伝説へ…』","ドラゴンクエスト モンスターズ　テリーのワンダーランド","ゲームボーイ　ドラゴンクエスト I・II",
            "取扱説明書","「ドリームキャスト」","ドリキャス","ドリームファクトリー","ドルフィン（仮称）","ナムコ","日本ゲーム大賞","ニュートラル","任意スクロール","任天堂","ニンテンドー ゲームキューブ",
            "ニンテンドー パワー","ニンテンドー 64","ぬるい","ぬるゲーマー","ネオジオ","ネオジオ CD","ネオジオ CD Z","ネオジオポケット","ネオジオポケット カラー","熱暴走","ノーコン",
            "ノンプレイヤーキャラクター","ノーミス","バーチャルボーイ","バーチャルリアリティ","パーティ","ハード","ハードメーカー","ハードリセット","ハイスコア","ハイレゾパック","バカゲー",
            "バグ","バグる","パズル","パスワード","パソコンゲーム","パターン","発狂","バッテリーバックアップ","バッドエンディング","パブリッシャー","はまる","パラメーター","ハリネズミ",
            "パワーメモリ","頒布権","光るネズミ","ヒゲおやじ","ビジュアルメモリ","必殺技","ヒットチェック","ヒットポイント","ピピン＠","ピヨる","ファイナルファンタジー　シリーズ ","ファイナルファンタジー",
            "ファイナルファンタジー II","ファイナルファンタジー III","ファイナルファンタジー IV","ファイナルファンタジー V","ファイナルファンタジー VI","ファイナルファンタジー VII","ファイナルファンタジー VIII",
            "ファイナルファンタジー IX","ファイナルファンタジー I・II","ファイナルファンタジー コレクション","ファミコン","ファミコン以前","ファミリーコンピュータ","ふっかつのじゅもん","フラグ",
            "プラットフォーマー","プラットフォーム","プラットフォーム・ホルダー","プリクラ","プリント倶楽部","ぷるぷるパック","プレイステーション","プレイステーション２","プレイヤーキラー","プレステ",
            "プロ・アクション・リプレイ","ペーパーボーイ","ベストエンディング","ポケットモンスター","ポケットモンスター赤（緑）","ポケットモンスター ピカチュウ","ポケットモンスター青","ポケットモンスター金（銀）",
            "ポケモン","ポケモンセンター","ポケモンブーム","ポリゴン","ホワイトユーザー","麻雀ゲーム","マイク","マイクロソフト","マスクROM","待ち","松下電器産業","マッピング","魔法","マルチエンディング",
            "マルチプラットフォーム","見切り","ミスリル","ミスる","みそ","宮本茂","ムービー","無敵","目押し","メスト","メダル","メダルゲーム","メディア","萌える","ACCS","ACES","ACT","ADV","AMショー",
            "AOU","AOUアミューズメントエキスポ","A・RPG","ARTS","AVG","Bダッシュ","CD","CD-DA","CD音源","CD-ROM","CES","CESA","CESA大賞","CPU","CSK","DC","DDR","DQ","DVD","DVD オーディオ",
            "DVD-RAM","DVD-ROM","DVD ビデオ","E3","E野","FC","FF","GB","GD-ROM","GRJ","GScube","HP","IEEE 1394","i.Link","ISAO","JAMMA","JPSA","NES","NOA","PAR","PK","Play Online",
            "PlayOnline.com","PS","PS2","ROM","SFC","FC","FF","GB","GD-ROM","GRJ","GScube","HP","IEEE 1394","i.Link","ISAO","JAMMA","JPSA","NES","NOA","PAR","PK","Play Online",
            "PlayOnline.com","PS","PS2","ROM","SFC","垢","アクティブ"]
        ReturnWordArray += wordArray
        
        wordArray = ["運営","カンスト","クエスト","ググれ","君主つえぇ","げえっ！","元素","孔明の罠だ","光栄の罠だ","鯖","三ＯＮ","死に戻り","衝車","銭荘","タゲ","チート","チャット","敵対値","敵を釣る",
             "デスペナ","投石車","トン兄（惇兄）","脳筋","ノンアクティブ","バフ（Ｂｕｆｆ）","デバフ（ＤｅＢｕｆｆ）","武将タイム","フレア","ヘイト","村","森","リンク","レイド","ＡＦＫ","ＢＯＴ",
             "ＣＢ","ｃｃ","ＦＡ","ＧＭ","GvG","Limechat","ＭＯＢ","ＭＭＯ","ＮＰＣ","ＯＢ","ＰＣ","ＰＤ","ＰＫ","ＰＯ","ＭＰＫ","ＰＴ","Plz","PvP","PvN","ＲＭＴ","ROM","RvR","SOL","VC",
             "wis","＠"]
        ReturnWordArray += wordArray
        
        wordArray = ["相方","アイテム課金","垢","アカウント","垢バン","アクティブ","アクティブスキル","アバター","アビューズ行為","イナゴ","芋","イン","引退","引退セール","ウインドウモード","ウェブマネー",
              "運営","永久機関","永久無料","詠唱反応","エミュ鯖","エンカウント","オープンβ","落ちる","オフ会","オフライン","重い","オン","オンボード","オンライン","価格操作","課金","課金アイテム",
              "ガチャ","狩場","狩場争い","火力","カンスト","壁","基本無料","キャラクター","キャラセレ","キャンパー","キムチパーティー","キャラデリ","業者","ギルド","ギルマス","ギルメン","ギルハン",
              "緊急メンテ","キック","クエスト","グラフィックボード","クリックゲーム","クリチョンゲー","クローズドβ","クライアント","クラン","ゲームサーバー","ゲームバランス","ゲームマスター",
              "月額課金","公式","公式BOT","公式RMT","攻城戦","誤爆","コンプリートガチャ","再振り","晒し","鯖","サービス終了","サブキャラ","シーフ","自家発電","支援","直取引","したらば",
              "重課金","種族","職業","処理落ち","地雷","スキル","スタートダッシュ","スタイリッシュハイパー重課金ゲーム","スタック","ステ","ステータス","生産","生産系","正式サービス","精錬",
              "全体チャット","ソーシャルネットワークゲーム","倉庫キャラ","相場","ソロ","ソロPT","タゲ","タゲ取り","多重","盾","タンク","タンカー","チート","追尾","辻","釣り",
              "定期メンテ","定点マクロ","デスペナ","転売","都市伝説","ドラゴン課金","トレイン","ドロップ","ドロップアイテム","中の人","日本オンラインゲーム協会","日本独自仕様","肉染み和え",
              "寝落ち","ネカマ","ネガキャン","ネガティブ","ネナベ","寝マクロ","ネームド","脳筋","仰け反り","ノックバック","野良PT","ノンアクティブモンスター","パーティ","ハイエナ","拝金主義",
              "廃人","ハイブリッド課金","バグ","パスワード","パッケージ","パッシブ","パッシブスキル","パッチ","ハラスメント","バラマキ","パワーレベリング","ハンゲ民","被ダメ","ヒットストップ",
              "不具合","複垢","フルスクリーンモード","プレイヤー","プレイヤースキル","ブラウザゲーム","ブログ","ブロント語","ヘイト","ベンチマーク","巻き戻り","マクロ","マルチプレイ","ミス",
              "見抜き","無課金","村ゲー","メンテ","メタバース","ユーザー","ユニオン","ユニクロ","洋ゲー","養殖","横狩り","横殴り","横取り","与ダメ","ラグ","ラグ死","らん豚","リアル",
              "リスポン、リスポーン","量産型ネットゲーム","リログ","リンク","ルート","ルート権","レイド","ローカライズ","ログ","ログイン","ログインオンライン","ログアウト","ロールバック",
              "ワイプ","湧く","罠","わんわん","ヲチ","AA","AFK","BA","BOT","Browser Game","Buff","Buffer","CC","CGI Game","DOT","DPS","Drop","Dupe","Enchant","Enchanter",
              "F2P","FA","FPS","G","ggr","GJ","GM","GvG","HP","HC","ID","IRC","k","KY","ks","LS","Lv","Lvling","M","Mail Game","MMO","MMORPG","MO","MORPG","Mob","MP",
              "MPK","MSN","Multi play","NET CASH","Noob","NPC","nProtect","NSW","On Board Device","On Board Graphic","On Board Sound","orz","P2W","PC","Ping","PK","PKK",
